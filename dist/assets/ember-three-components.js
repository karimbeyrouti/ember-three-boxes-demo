  ...
  */
  ...
  let Controls = (_class = (_temp = class Controls extends _component.default {
    ...
    initializer: function () {
      return ['cubes', 'lines', 'interactive-cubes', 'shadow-cubes'];
    }
  ...
  */
  ...
  let InteractiveCubeDemoComponent = (_dec = Ember.inject.service('ember-three/scene-manager'), (_class = (_temp = class InteractiveCubeDemoComponent extends _component.default {
    constructor() {
      ...
      (0, _defineProperty2.default)(this, "spotLightPosition", new _three.default.Vector3(getRandomInt(20, 60), getRandomInt(20, 80), getRandomInt(10, 30)));
...
;
          if (!runningTests) {
            require("ember-three-components/app")["default"].create({"name":"ember-three-components","version":"0.0.0+86e90720"});
          }
